...
window_name, base_class = uic.loadUiType("septiembre.ui")
...
class MainWindow(window_name, base_class):
    def __init__(self):
        ...
        self.boton_spoopy.clicked.connect(self.boom)
