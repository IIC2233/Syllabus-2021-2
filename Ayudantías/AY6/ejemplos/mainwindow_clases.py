...
class MiVentana(QWidget):
    ...
    def boton1_callback(self):
        """
        Este método es el encargado ejecutar una acción
        cada vez que el botón es presionado. En esta caso,
        realiza el cambio en label2 y el status bar mediante
        la emisión de una señal en la cual se envía el texto correspondiente.
        """
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        buscar = QAction(QIcon(os.path.join('img', 'search_icon.png')),
                         '&Search', self)
