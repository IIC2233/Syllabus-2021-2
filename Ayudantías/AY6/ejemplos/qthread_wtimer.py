...
"""
Tambien puedes heredar de QTimer para crear timers personalizados,
igual que con QThreads. En la clase de interfaces graficas 2 hay
un ejemplo, en esta ayudantia queremos mostrar su utilidad general.
"""
...
class VentanaConThread(QWidget):
    ...
    def actualizar_label(self):
        ...
        # Idealmente, deberias implementar un timer personalizado
    ...
    def iniciar_loop(self):
        # Los timers emiten una senal cada vez que pasa una cantidad
        # de tiempo especificada la cual puedes acceder para conectarla
        # utilizando el atributo timeout.
